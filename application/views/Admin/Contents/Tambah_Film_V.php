        ...
        <form action="">
            ...
            <div class="form-check-inline"> 
                ...
                <label class="form-check-label" for="radio2">
                    <input type="radio" class="form-check-input" name="optradio" value="kategori3">13+
                </label>
                <label class="form-check-label" for="radio3">
                    <input type="radio" class="form-check-input" name="optradio" value="kategori3">17+
                </label>
                <label class="form-check-label" for="radio3">
                    <input type="radio" class="form-check-input" name="optradio" value="kategori3">21+
                </label>
             </div>
             <br>
             <div class="form-group">
            ...
            <a href=""><button class="btn-danger">Cancel</button></a> <a href=""><button class="btn-success">Next</button></a>
        </form>
    </div>
    </div>