...
class JadwalTayang extends CI_Controller {
	...
	public function index()
	{
		$data = array();
		$data['css'] = 'Admin';
		$data['jadwaltayang'] = $this->Admin_M->Read_JadwalTayang();

		$this->load->view('Admin/Template/Header_V', $data);
		$this->load->view('Admin/Contents/JadwalTayang_V', $data);
	...
	public function Add()
	{
		$data = array();
		$data['css'] = 'Admin';
		$data['movie'] = $this->Admin_M->Read_Film();
		$data['cinema'] = $this->Admin_M->Read_Cinema();
		$data['studio'] = $this->Admin_M->Read_FStudio();
		



		$this->load->view('Admin/Template/Header_V', $data);
		$this->load->view('Admin/Contents/JadwalTayang_Create_V', $data);
		$this->load->view('Admin/Template/Footer_V');
	}
	...
	public function get_studio(){
		...
		$data=$this->Admin_M->Get_cinema_Studio($id);
